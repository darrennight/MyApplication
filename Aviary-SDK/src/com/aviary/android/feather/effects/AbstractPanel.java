...
public abstract class AbstractPanel {
	...
	public static interface OnPreviewListener {
		 ...
		 * @param result
		 *            the result
		 * @param reset_matrix reset the imageview
		 */
	...
	public static interface OnErrorListener {
		...
		void onMessage( CharSequence title, CharSequence message, int yesLabel, OnClickListener yesListener, int noLabel,
	...
	protected void onComplete( Bitmap bitmap, MoaActionList actions ) {
		...
		if ( mApplyListener != null && isActive() ) {
			...
			if ( !mTrackingAttributes.containsKey( "renderTime" ) ) mTrackingAttributes.put( "renderTime",
					Long.toString( t - mRenderTime ) );
	...
	protected void onGenericError( String message, int yesLabel, OnClickListener yesListener, int noLabel,
			OnClickListener noListener ) {
		if ( mErrorListener != null && isActive() ) {
	...
	protected void onGenericMessage( CharSequence title, CharSequence message, int yesLabel, OnClickListener yesListener,
			int noLabel, OnClickListener noListener ) {
		if ( null != mErrorListener && isActive() ) {
