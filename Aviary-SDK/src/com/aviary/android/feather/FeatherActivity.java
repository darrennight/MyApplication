...
public class FeatherActivity extends MonitoredActivity implements OnToolbarClickListener, OnImageDownloadListener, OnToolListener,
		FeatherContext, OnBitmapChangeListener, OnItemClickedListener, OnBottomBarItemClickListener, OnRestoreStateListener {
	...
	/** SHA-1 version id. */
	public static final String ID = "$Id: b3c060eb2e3e0235ee2c287dcf4e6a37fce54fdb $";
	...
	public void onCreate( Bundle savedInstanceState ) {
		...
		// TODO: remember to remove in production
	...
	protected void onInitializeController() {
		mMainController = new AviaryMainController( this, mUIHandler );
	}
	
	protected void onInitializePlugins() {
		// initialize plugins
		mMainController.initializePlugins();
	}

	protected void onPreCreate() {}

	/**
	 * Initialize the IntentFilter receiver in order to get updates about new
	 * installed plugins
	 */
	...
	protected void onToolsLoaded( List<ToolEntry> listEntries ) {
		...
		mToolsList.setAdapter( new ListAdapter( this, mListEntries, Moa.hasWhiteLabel() ) );
			...
			public void run() {
				...
				if ( mMainController != null ) {
					...
					if ( mMainController.getOriginalBitmap() != null ) {
						mImageRestore.getRestoredImageView().setImageBitmap( mMainController.getOriginalBitmap(), null, -1,
		...
		if ( null != data ) {
			...
			if ( null != bundle ) {
				try {
					...
					newexif.setAttribute( ExifInterfaceExtended.TAG_EXIF_SOFTWARE, "Aviary for Android " + SDK_VERSION );
	...
	@SuppressWarnings ( "deprecation" )
	@Override
	public boolean onItemClick( final AdapterView<?> parent, final View view, int position, long id ) {
