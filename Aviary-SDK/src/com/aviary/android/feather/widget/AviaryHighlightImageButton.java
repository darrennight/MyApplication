...
public class AviaryHighlightImageButton extends ImageView {
	...
	public AviaryHighlightImageButton ( Context context, AttributeSet attrs, int defStyle ) {
		...
		if ( drawable instanceof GlowBitmapDrawable ) {
			...
			glow.updateConfig( mHighlightColorPressed, mHighlightColorChecked, mHighlightColorSelected, mGlowSize, mHighlightMode,
					mGlowStatus );
		}
			
		// TODO: verify this
		//} else if( drawable instanceof GlowDrawable ) {
		//	((GlowDrawable)drawable).update( mHighlightColorPressed, mHighlightColorChecked, mHighlightColorSelected, mGlowSize, mHighlightMode, mGlowStatus );
		//}
	}
	...
	public void setImageDrawable( Drawable drawable ) {
		...
		if ( drawable instanceof BitmapDrawable ) {
			...
			if ( current instanceof GlowBitmapDrawable ) {
				...
				drawable = new GlowBitmapDrawable( getResources(), ( (BitmapDrawable) drawable ).getBitmap(),
						mHighlightColorPressed, mHighlightColorChecked, mHighlightColorSelected, mGlowSize, mHighlightMode,
						mGlowStatus );
			}
			...
			//	drawable = current;
			//} else {
			//	drawable = new GlowDrawable( getResources(), drawable, mHighlightColorPressed, mHighlightColorChecked, mHighlightColorSelected, mGlowSize, mHighlightMode, mGlowStatus );
			//}
		}
	...
	public void setImageBitmap( Bitmap bm ) {
		Log.i( VIEW_LOG_TAG, "setImageBitmap" );
		...
		setImageDrawable( new GlowBitmapDrawable( getResources(), bm, mHighlightColorPressed, mHighlightColorChecked,
